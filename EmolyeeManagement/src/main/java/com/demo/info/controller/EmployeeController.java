...
public class EmployeeController {
	...
	public String processAdd(@ModelAttribute("employee") Employee employee, BindingResult result, ModelMap model) {
	...
	public String processUpdate(@ModelAttribute("employee") Employee employee, BindingResult result, ModelMap model) {
		this.employeeService.saveEmployee(employee);
		return "redirect:/welcome/employees";
	}
